...
describe('PokemonListComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      //Essentially I am telling Angular that anything in this component that needs PokeService, use the PokeMockService class instead
      providers: [{provide: PokeService, useClass: PokeMockService}]
    })
    .compileComponents();
  ...
  it('Title should change to "title has been changed!" when change the title! button is clicked', () => {
    ...
    //Since data has change in the TS file, a special lifecycle hook needs to be executed to actually persists that change
