...
describe('PokeService', () => {
  ...
  beforeEach(() => {
    //This is similar to @NgModule and we have to set the dependencies for this testing environment
    //Start thinking the testing environment is a completely new angular project and you have to state all the dependencies all over again
